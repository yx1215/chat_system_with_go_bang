...
menu = "\n++++ Choose one of the following commands\n \
        ...
        g _peer_: to connect and play game with _peer_\n \
        single_g: to play game with yourself\n \
...
def print_state(state):
    ...
    if state == S_OFFLINE:
        ...
        print('Gaming')
    elif state == S_CHOOSE_COLOR:
        print("Choosing color")
    elif state == S_REVEIVE_REQUEST:
        print("Request received")
    elif state == S_WAIT_FOR_GAME:
